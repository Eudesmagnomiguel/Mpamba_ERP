export const PERMISSIONS = {
	...
	BILLING_CREDIT_NOTE_CREATE: 'billing:credit_note:create',
	BILLING_CREDIT_NOTE_VIEW: 'billing:credit_note:view',
	...
	TREASURY_ACCOUNT_UPDATE: 'treasury:account:update',
	TREASURY_ACCOUNT_DELETE: 'treasury:account:delete',
