...
// Antes de /:id, senão «pgc» seria lido como o id de uma conta.
router.get('/pgc', permissionGuard(PERMISSIONS.ACCOUNTING_ACCOUNT_VIEW), (req, res) => accountingAccountController.pgcReference(req as any, res));
